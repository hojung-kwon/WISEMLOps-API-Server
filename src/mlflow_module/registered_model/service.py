...
class RegisteredModelService:
    ...
    def create_registered_model(self, name: str, tags: Optional[Dict[str, Any]] = None,
        ...
        try:
            result = self.get_mlflow_client().create_registered_model(name, tags=tags, description=description)
            return result
    ...
    def delete_registered_model(self, name: str):
        try:
            result = self.get_mlflow_client().delete_registered_model(name)
            return result
        except MlflowException as e:
            raise MlflowApiError(e)
    ...
    def delete_registered_model_alias(self, name: str, alias: str):
        try:
            self.get_mlflow_client().delete_registered_model_alias(name, alias)
            return name
        except MlflowException as e:
            raise MlflowApiError(e)
    ...
    def delete_registered_model_tag(self, name: str, key: str):
        try:
            self.get_mlflow_client().delete_registered_model_tag(name, key)
            return name
        except MlflowException as e:
            raise MlflowApiError(e)
    ...
    def get_registered_model(self, name: str):
        try:
            result = self.get_mlflow_client().get_registered_model(name)
            return result
        except MlflowException as e:
            raise MlflowApiError(e)
    ...
    def rename_registered_model(self, name: str, new_name: str):
        try:
            result = self.get_mlflow_client().rename_registered_model(name, new_name)
            return result
        except MlflowException as e:
            raise MlflowApiError(e)
    ...
    def search_registered_models(self, filter_string: Optional[str] = None, max_results: int = 100,
        ...
        try:
            result = self.get_mlflow_client().search_registered_models(filter_string=filter_string,
    ...
    def set_registered_model_alias(self, name: str, alias: str, version: str):
        try:
            self.get_mlflow_client().set_registered_model_alias(name, alias, version)
            return name
        except MlflowException as e:
            raise MlflowApiError(e)
    ...
    def set_registered_model_tag(self, name: str, key: str, value: Any):
        try:
            self.get_mlflow_client().set_registered_model_tag(name, key, value)
            return name
        except MlflowException as e:
            raise MlflowApiError(e)
    ...
    def update_registered_model(self, name: str, description: Optional[str] = None):
        try:
            result = self.get_mlflow_client().update_registered_model(name, description=description)
            return result
        except MlflowException as e:
            raise MlflowApiError(e)
