...
async def archive_experiment(experiment_id: str):
    return Response.from_result(kfp_service.archive_experiment(experiment_id=experiment_id))


@router.delete("/experiments/{experiment_id}", tags=["kfp"], response_model=APIResponseModel)
async def delete_experiment(experiment_id: str):
    return Response.from_result(kfp_service.delete_experiment(experiment_id=experiment_id))


@router.get("/pipelines", tags=["kfp"], response_model=APIResponseModel)
async def list_pipelines():
    return Response.from_result(kfp_service.list_pipelines())


@router.post("/pipelines", tags=["kfp"], response_model=APIResponseModel)
async def upload_pipeline(pipeline: Pipeline):
    return Response.from_result(kfp_service.upload_pipeline(pipeline))


@router.get("/pipelines/{pipeline_id}", tags=["kfp"], response_model=APIResponseModel)
async def get_pipeline(pipeline_id: str):
    return Response.from_result(kfp_service.get_pipeline(pipeline_id))
...
async def get_pipeline_template(pipeline_id: str):
    return Response.from_result(kfp_service.get_pipeline_template(pipeline_id))
...
async def list_pipeline_versions(pipeline_id: str):
    return Response.from_result(kfp_service.list_pipeline_versions(pipeline_id))


@router.delete("/pipelines/{pipeline_id}", tags=["kfp"], response_model=APIResponseModel)
async def delete_pipeline(pipeline_id: str):
    return Response.from_result(kfp_service.delete_pipeline(pipeline_id))
...
async def get_pipeline_id(pipeline_name: str):
    return Response.from_result(kfp_service.get_pipeline_id(pipeline_name))
...
async def upload_pipeline_version(pipeline_version: PipelineVersion):
    return Response.from_result(kfp_service.upload_pipeline_version(pipeline_version))
...
async def get_pipeline_version(version_id: str):
    return Response.from_result(kfp_service.get_pipeline_version(version_id))
...
async def get_pipeline_version_template(version_id: str):
    return Response.from_result(kfp_service.get_pipeline_version_template(version_id))
...
async def delete_pipeline_version(version_id: str):
    return Response.from_result(kfp_service.delete_pipeline_version(version_id))


@router.get("/runs", tags=["kfp"], response_model=APIResponseModel)
async def list_runs():
    return Response.from_result(kfp_service.list_runs())


@router.post("/runs", tags=["kfp"], response_model=APIResponseModel)
async def create_run_from_pipeline_package(run: Run):
    return Response.from_result(kfp_service.create_run_from_pipeline_package(run))


@router.get("/runs/{run_id}", tags=["kfp"], response_model=APIResponseModel)
async def get_run(run_id: str):
    return Response.from_result(kfp_service.get_run(run_id))
...
async def wait_for_run_completion(run_id: str, timeout: int):
    return Response.from_result(kfp_service.wait_for_run_completion(run_id, timeout))


@router.get("/recurring-runs", tags=["kfp"], response_model=APIResponseModel)
async def list_recurring_runs():
    return Response.from_result(kfp_service.list_recurring_runs())
...
async def create_recurring_run(recurring_run: RecurringRun):
    return Response.from_result(kfp_service.create_recurring_run(recurring_run))


@router.get("/recurring-runs/{job_id}", tags=["kfp"], response_model=APIResponseModel)
async def get_recurring_run(job_id: str):
    return Response.from_result(kfp_service.get_recurring_run(job_id))


@router.delete("/recurring-runs/{job_id}", tags=["kfp"], response_model=APIResponseModel)
async def delete_job(job_id: str):
    return Response.from_result(kfp_service.delete_job(job_id))


@router.patch("/recurring-runs/{job_id}", tags=["kfp"], response_model=APIResponseModel)
async def disable_job(job_id: str):
    return Response.from_result(kfp_service.disable_job(job_id))


@router.get("/artifact/{run_id}/{node_id}/{artifact_name}", tags=["kfp"], response_model=APIResponseModel)
async def read_artifact(run_id: str, node_id: str, artifact_name: str):
    return Response.from_result(kfp_service.read_artifact(run_id, node_id, artifact_name))


@router.get("/detail/{run_id}", tags=["kfp"], response_model=APIResponseModel)
async def get_run_detail(run_id: str):
    return Response.from_result(kfp_service.get_run_detail(run_id))
