...
from src.mlflow_client_module.exceptions import MlflowApiError, MlflowException
...
class ExperimentService:
    ...
    def delete_experiment(self, experiment_id: str):
        try:
            self._mlflow_client.delete_experiment(experiment_id)
    ...
    def rename_experiment(self, experiment_id: str, new_name: str):
        try:
            self._mlflow_client.rename_experiment(experiment_id, new_name)
            return experiment_id
        except MlflowException as e:
            raise MlflowApiError(e)
    ...
    def restore_experiment(self, experiment_id: str):
        try:
            self._mlflow_client.restore_experiment(experiment_id)
            return experiment_id
        except MlflowException as e:
            raise MlflowApiError(e)
    ...
    def set_experiment_tag(self, experiment_id: str, key: str, value: Any):
        try:
            self._mlflow_client.set_experiment_tag(experiment_id, key, value)
            return experiment_id
        except MlflowException as e:
            raise MlflowApiError(e)
