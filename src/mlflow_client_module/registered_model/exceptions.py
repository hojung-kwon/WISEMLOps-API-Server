...
from src.mlflow_client_module.registered_model import MODULE_CODE


class MlflowRegisteredException(Exception):
...
class MlflowRegisteredError(MlflowRegisteredException):
