...
async def get_volume_claims(namespace: str = 'default'):
    return Response.from_result(cluster_service.get_volume_claims(namespace))
...
async def create_volume_claim(namespace: str, pvc: VolumeClaim):
    return Response.from_result(cluster_service.create_volume_claim(namespace, pvc))
...
async def delete_volume_claim(namespace: str, name: str):
    return Response.from_result(cluster_service.delete_volume_claim(namespace, name))
...
async def get_config_maps(namespace: str = 'default'):
    return Response.from_result(cluster_service.get_config_maps(namespace))
...
async def create_config_map(namespace: str, config_map: ConfigMap):
    return Response.from_result(cluster_service.create_config_map(namespace, config_map))
...
async def delete_config_map(namespace: str, name: str):
    return Response.from_result(cluster_service.delete_config_map(namespace, name))


@router.get("/namespaces/{namespace}/secrets", tags=["secret"], response_model=Response)
async def get_secrets(namespace: str = 'default'):
    return Response.from_result(cluster_service.get_secrets(namespace))
...
async def create_secret(namespace: str, secret: Secret):
    return Response.from_result(cluster_service.create_secret(namespace, secret))
...
async def delete_secret(namespace: str, name: str):
    return Response.from_result(cluster_service.delete_secret(namespace, name))
...
async def get_pods(namespace: str = 'default', label_selector: str = None):
    return Response.from_result(cluster_service.get_pods(namespace, label_selector))
...
async def find_specific_pod_logs(namespace: str, label_selector: str = None):
    return Response.from_result(cluster_service.find_specific_pod_logs(namespace, label_selector))
...
async def get_pod_logs(namespace: str, name: str):
    return Response.from_result(cluster_service.get_pod_logs(namespace, name))
...
async def get_container_logs(namespace: str, name: str, container: str):
    return Response.from_result(cluster_service.get_container_logs(namespace, name, container))
...
async def create_namespaced_pod(namespace: str, pod: Pod):
    return Response.from_result(cluster_service.create_pod(namespace, pod))
...
async def delete_namespaced_pod(namespace: str, name: str):
    return Response.from_result(cluster_service.delete_pod(namespace, name))
...
async def get_deployments(namespace: str = 'default'):
    return Response.from_result(cluster_service.get_deployments(namespace))
...
async def create_deployment(namespace: str, deployment: Deployment):
    return Response.from_result(cluster_service.create_deployment(namespace, deployment))
...
async def delete_deployment(namespace: str, name: str):
    return Response.from_result(cluster_service.delete_deployment(namespace, name))
...
async def get_services(namespace: str = 'default'):
    return Response.from_result(cluster_service.get_services(namespace))
...
async def create_service(namespace: str, service: Service):
    return Response.from_result(cluster_service.create_service(namespace, service))
...
async def delete_service(namespace: str, name: str):
    return Response.from_result(cluster_service.delete_service(namespace, name))
...
async def get_ingresses(namespace: str = 'default'):
    return Response.from_result(cluster_service.get_ingresses(namespace))
...
async def create_ingress(namespace: str, ingress: Ingress):
    return Response.from_result(cluster_service.create_ingress(namespace, ingress))
...
async def delete_ingress(namespace: str, name: str):
    return Response.from_result(cluster_service.delete_ingress(namespace, name))
